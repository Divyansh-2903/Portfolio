...
const qualitySettings = {
  low: { iterations: 18, waveIterations: 1, pixelRatio: 0.45, precision: 'mediump', stepMultiplier: 1.65, targetFPS: 20 },
  medium: { iterations: 30, waveIterations: 2, pixelRatio: 0.6, precision: 'mediump', stepMultiplier: 1.35, targetFPS: 24 },
  high: {
    iterations: 48,
    waveIterations: 3,
    pixelRatio: 0.9,
...
export default function LightPillar({
  ...
  useEffect(() => {
    ...
    const baseSettings = qualitySettings[effectiveQuality] || qualitySettings.medium;
    const settings = {
      ...baseSettings,
      pixelRatio: effectiveQuality === 'high' ? Math.min(window.devicePixelRatio || 1, baseSettings.pixelRatio) : baseSettings.pixelRatio,
    };
    ...
    const animate = (currentTime: number) => {
      ...
      if (inViewportRef.current && documentVisibleRef.current && deltaTime >= frameTime) {
